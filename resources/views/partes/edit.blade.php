            ...
            <form action="{{ route('partes.update', $parte->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <select required id="cliente" name="cliente"
                        ...
                        @foreach ($clientes as $cliente)
                            <option value="{{ $cliente->nombre }}"
                                {{ $cliente->nombre === $parte->cliente ? 'selected' : '' }}>
                                {{ $cliente->nombre }}
                            </option>
                        @endforeach
                    </select>
                    ...
                    <div class="mb-4">
                        ...
                        <input required type="date" value="{{ $parte->fecha }}" id="fecha" name="fecha"
                            class="w-full px-4 py-2 border rounded-md bg-gray-50 focus:outline-none focus:border-blue-500">
                    </div>
                        ...
                        <select id="departamento" name="departamento"
                            ...
                            @foreach ($departamentos as $departamento)
                                <option value="{{ $departamento->nombre }}"
                                    {{ $departamento->nombre === $parte->departamento ? 'selected' : '' }}>
                    ...
                    <div class="mb-4">
                        <label for="horas_totales" class="block text-gray-700 font-bold mb-2">Horas
                            Totales:</label>
                        <input type="text" id="horas_totales" name="horas_totales"
                            class="w-full px-4 py-2 border rounded-md bg-gray-50 focus:outline-none focus:border-blue-500"
                            value="{{ $parte->horas_totales }}">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="trabajos_realizados" name="trabajos_realizados" rows="4"
                            class="w-full px-4 py-2 border rounded-md bg-gray-50 focus:outline-none focus:border-blue-500">{{ $parte->trabajos_realizados }}</textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        <label for="realizado_por" class="block text-gray-700 font-bold mb-2">Realizado
                            por:</label>
                        <select id="realizado_por" name="realizado_por"
                            class="w-full px-4 py-2 border rounded-md bg-gray-50 focus:outline-none focus:border-blue-500">
                            @foreach ($empleados as $empleado)
                                <option value="{{ $empleado->id }}"
                                    {{ $parte->trabajador_id == $empleado->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-4">
                        <label for="revisado_por" class="block text-gray-700 font-bold mb-2">Revisado
                            por:</label>
                        <input type="text" id="revisado_por" name="revisado_por"
                            class="w-full px-4 py-2 border rounded-md bg-gray-50 focus:outline-none focus:border-blue-500"
                            value="{{ $parte->revisado_por }}">
                    </div>

                    <!-- Desplazamiento -->
                    <div class="mb-4">
                        <label for="desplazamiento" class="block text-gray-700 font-bold mb-2">Desplazamiento:</label>
                        <input type="checkbox" id="desplazamiento" name="desplazamiento" value="1"
                            class="mr-2 leading-tight" {{ $parte->desplazamiento ? 'checked' : '' }}>
                    ...
                    <div id="detalles_desplazamiento" class="mb-4 {{ $parte->desplazamiento ? '' : 'hidden' }}">
                        <div class="mb-2">
                            <select
                                class="border border-gray-300 rounded-md px-1 py-1 focus:outline-none focus:border-blue-500"
                                name="tipo_desplazamiento" id="desplazamiento">
                    ...
                    <div class="mb-4">
                        ...
                        <div>
                            <input type="checkbox" id="maquinaria" name="maquinaria" value="1"
                                class="mr-2 leading-tight" {{ $parte->maquinaria ? 'checked' : '' }}>
                    ...
                    <div id="detalles_maquinaria" class="mb-4 {{ $parte->maquinaria ? '' : 'hidden' }}">
                        <div class="mb-2">
                            <select
                                class="border border-gray-300 rounded-md px-1 py-1 focus:outline-none focus:border-blue-500"
                                name="tipo_maquinaria" id="maquinaria">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="number" id="horas_maquinaria" name="horas_maquinaria"
                                class="w-full px-4 py-2 border rounded-md bg-gray-50 focus:outline-none focus:border-blue-500"
                                value="{{ $parte->horas_maquinaria }}">
                        </div>
                        <div class="mb-2">
                            <label for="observaciones_maquinaria"
                                class="block text-gray-700 font-bold mb-2">Observaciones:</label>
                            <textarea id="observaciones_maquinaria" name="observaciones_maquinaria" rows="2"
                                class="w-full px-4 py-2 border rounded-md bg-gray-50 focus:outline-none focus:border-blue-500">{{ $parte->observaciones_maquinaria }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div>
                            <input type="checkbox" id="precio" name="precio" value="1"
                                class="mr-2 leading-tight" {{ $parte->precio ? 'checked' : '' }}>
                    ...
                    <div id="detalles_precio" class="mb-4 {{ $parte->precio ? '' : 'hidden' }}">
                        <div class="mb-2">
                            <label for="cantidad_precio"
                                class="block text-gray-700 font-bold mb-2">Cantidad(€):</label>
                            <input type="text" id="cantidad_precio" name="cantidad_precio"
                                class="w-full px-4 py-2 border rounded-md bg-gray-50 focus:outline-none focus:border-blue-500"
                                value="{{ $parte->cantidad_precio }}">
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select id="estado_trabajador" name="estado_trabajador"
                            ...
                            <option value="vacaciones"
                                {{ 'vacaciones' === $parte->estado_trabajador ? 'selected' : '' }}>
                                Vacaciones</option>
                    ...
                    <div id="detalles_estado" class="mb-4 {{ $parte->estado_trabajador ? '' : 'hidden' }}">
                        <label for="detalles_otros" class="block text-gray-700 font-bold mb-2">Detalles
                            (Opcional):</label>
                        <textarea id="detalles_otros" name="detalles_otros" rows="2"
                            class="w-full px-4 py-2 border rounded-md bg-gray-50 focus:outline-none focus:border-blue-500">{{ $parte->detalles_otros }}</textarea>
                    </div>
